...
MAP_GEN_SETTINGS_SCHEMA = [
    ...
    _field("autoplace_controls.fulgora_cliff", "Fulgora Cliffs", "Frequency, size and richness of cliffs on Fulgora.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 2.0, "richness": 0.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["fulgora"], space_age_exclusive=True, order_="c-z-c"),
    _field("autoplace_controls.gleba_cliff", "Gleba Cliffs", "Frequency, size and richness of cliffs on Gleba.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 2.0, "richness": 0.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["gleba"], space_age_exclusive=True, order_="c-z-b"),
