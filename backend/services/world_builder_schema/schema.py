...
MAP_GEN_SETTINGS_SCHEMA = [
    ...
    _field("autoplace_controls.gleba_water", "Gleba Water", "Frequency and size of water patches on Gleba.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["gleba"], order_="c-z-b", can_be_disabled=False),
    _field("autoplace_controls.gleba_plants", "Gleba Plants", "Frequency and size of plant life on Gleba.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["gleba"], order_="c-z-c", can_be_disabled=False),
    _autoplace("scrap", "Scrap", "Frequency and size of scrap piles.", planet_exclusive=["fulgora"], order_="d-a"),
    _field("autoplace_controls.fulgora_islands", "Fulgora Islands", "Frequency and size of islands on Fulgora.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["fulgora"], order_="c-z-d", can_be_disabled=False),
    ...
    _field("autoplace_controls.vulcanus_volcanism", "Vulcanus Volcanism", "Frequency and size of volcanic activity on Vulcanus.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["vulcanus"], order_="c-z-a", can_be_disabled=False),
