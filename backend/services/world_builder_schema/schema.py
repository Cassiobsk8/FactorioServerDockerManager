...
def _autoplace(
    ...
    can_be_disabled: bool = True,
    category: str = CATEGORY_RESOURCES,
) -> dict[str, Any]:
    data: dict[str, Any] = {
...
MAP_GEN_SETTINGS_SCHEMA = [
    ...
    _autoplace("stone", "Stone", "Frequency and size of stone deposits.", order_="a-c"),
    ...
    _field("autoplace_controls.water", "Water", "Frequency, size and richness of water patches.", CATEGORY_WATER, "AutoplaceControl", default={"frequency": 1.0, "size": 1.0, "richness": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", order_="c-a"),
    ...
    _field("autoplace_controls.rocks", "Rocks", "Frequency, size and richness of rock patches.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 1.0, "richness": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", order_="c-y"),
    _field("autoplace_controls.starting_area_moisture", "Starting Area Moisture", "Frequency, size and richness of moisture in the starting area.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 1.0, "richness": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", order_="c-z"),
    _field("autoplace_controls.nauvis_cliff", "Nauvis Cliffs", "Frequency, size and richness of cliffs on Nauvis.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 2.0, "richness": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", order_="c-z"),
    ...
    _autoplace("scrap", "Scrap", "Frequency and size of scrap piles.", planet_exclusive=["fulgora"], order_="d-a"),
    _field("autoplace_controls.fulgora_islands", "Fulgora Islands", "Frequency, size and richness of islands on Fulgora.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 1.0, "richness": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["fulgora"], order_="c-z-d", can_be_disabled=False),
    ...
    _field("autoplace_controls.vulcanus_volcanism", "Vulcanus Volcanism", "Frequency, size and richness of volcanic activity on Vulcanus.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 1.0, "richness": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["vulcanus"], order_="c-z-a", can_be_disabled=False),
    _field("autoplace_controls.gleba_enemy_base", "Gleba Enemy Bases", "Frequency and size of enemy bases on Gleba.", CATEGORY_ENEMIES, "AutoplaceControl", default={"frequency": 1.0, "size": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["gleba"], order_="z", can_be_disabled=False),
    _field("autoplace_controls.fulgora_cliff", "Fulgora Cliffs", "Frequency, size and richness of cliffs on Fulgora.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 2.0, "richness": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["fulgora"], space_age_exclusive=True, order_="c-z-c"),
    _field("autoplace_controls.gleba_cliff", "Gleba Cliffs", "Frequency, size and richness of cliffs on Gleba.", CATEGORY_TERRAIN, "AutoplaceControl", default={"frequency": 1.0, "size": 2.0, "richness": 1.0}, min_=0.0, max_=10.0, source_file="map-gen-settings.json", planet_exclusive=["gleba"], space_age_exclusive=True, order_="c-z-b"),
